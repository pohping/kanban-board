...
export type MeQuery = { me: { id: string, name: string } };
...
export type CreateBoardMutation = { createBoard: { title: string, description: string | null } };
...
export type GetBoardQuery = { board: { id: string, title: string, description: string | null, labels: Array<{ id: string, name: string, color: string }>, members: Array<{ user: { id: string, name: string } }>, columns: Array<{ id: string, title: string, position: number, cards: Array<{ id: string, title: string, description: string | null, position: number, dueDate: string | null, commentCount: number, attachmentCount: number, assignees: Array<{ user: { id: string, name: string } }>, labels: Array<{ id: string, name: string, color: string }> }> }> } };
...
export type CreateColumnMutation = { createColumn: { title: string } };
...
export type MoveColumnMutation = { moveColumn: { id: string, position: number } };
